...
class Kennel extends StatefulWidget {
  @override
  _KennelState createState() => _KennelState();
}

class _KennelState extends State<Kennel> {
...
//                ),
                    ...
                    new Row(
                      ...
                      children: <Widget>[
                        new Radio(
                          ...
                          value: 0,
                          groupValue: KennelRadioValue,
                          onChanged: _handleKennelValueChange,
                        ),
                        new Text(
                          'Yes',
              ...
              InkWell(
                  onTap: () {
                    Global.spType = ServiceProviderType.Kennel;
...
//                        BottomTabsScreen.routeName, (route) => false);
  ...
  void _handleKennelValueChange(int value) {
    setState(() {
      KennelRadioValue = value;
    });
  }
  ...
  void _sendSignUpRequest(BuildContext context) {
    check().then((internet) async  {
      if (internet != null && internet) {
        progressDialog.show();
        parameters['ServiceProviderType'] = SEARCH_TYPES[3];
